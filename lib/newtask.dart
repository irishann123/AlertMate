...
class NewTaskPage extends StatefulWidget {
  ...
  const NewTaskPage({Key? key, required this.selectedDay}) : super(key: key);
...
class _NewTaskPageState extends State<NewTaskPage> {
  ...
  Future<void> _selectDate(BuildContext context) async {
    // Do nothing if a date is already selected
    if (_selectedDate != null) return;

    final DateTime pickedDate = widget.selectedDay;
    setState(() {
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField(
                  ...
                  onChanged: (newValue) {
                    setState(() {
                      _selectedRepeatOption = newValue as String?;
                    });
                  },
                  items: [
                    DropdownMenuItem(
                  ...
                  children: [
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        ...
                        backgroundColor:
                            const Color.fromARGB(236, 69, 36, 95),
        ...
        _speech.listen(
          onResult: (val) => setState(() {
            ...
            _eventDescriptionController.text =
                _text; // Set captured text to the TextField
          }),
        );
      }
    } else {
